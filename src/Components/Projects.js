...
const Projects = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-400 via-blue-100 to-blue-400 py-4 ">

        <div className='flex flex-wrap justify-center'>
        <h1 className= " text-center font-serif text-blue-900 font-bold sm:text-4xl text-3xl" > Projects  </h1>
